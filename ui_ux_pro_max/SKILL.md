...
Use the search tool (if available) or apply the design principles to select best matches for:
1. Pattern & Layout
2. Style & Aesthetics
3. Colors & Typography
4. Effects & Motion
...
Apply implementation-specific best practices for the chosen stack (default: `html-tailwind`).
